...
SECTION_POLISH_PROMPTS = {
    ...
    "system_overview": (
        "You are a senior technical writer producing a KT document.\n"
        "Section: {title}\n\n"
        "Rewrite these fragments into a concise system overview.\n"
        "Format:\n"
        "**Purpose:** [what the system does]\n"
        "**Core components:** [main services/platforms]\n"
        "**Key workflows:** [major business flow]\n"
    ...
    "plain_english_notes": (
        "You are a senior technical writer producing a KT document.\n"
        "Section: {title}\n\n"
        "Rewrite these fragments into plain-English operational notes.\n"
        "Format:\n"
        "- Start with the main gotcha or nuance.\n"
        "- Keep explanations simple and practical.\n"
        "- Preserve exact tool names, commands, and timings if mentioned.\n"
    ...
    "known_bad_days": (
        "You are a senior technical writer producing a KT document.\n"
        "Section: {title}\n\n"
        "Rewrite these fragments into a known bad days and windows reference.\n"
        "Format:\n"
        "**Window:** [day/time/window]\n"
        "**Risk:** [why it is risky]\n"
        "**Action:** [what to avoid or do]\n"
        "Do NOT add windows or risks not present in the input.\n"
        "Return only the formatted content, no heading.\n\n"
        "Source fragments:\n{fragments}\n\nFormatted output:"
    ),
    "cost_optimization": (
        "You are a senior technical writer producing a KT document.\n"
        "Section: {title}\n\n"
        "Rewrite these fragments into a cost optimization reference.\n"
        "Format:\n"
        "**Optimization area:** [area]\n"
        "**Action:** [measure or approach]\n"
        "**Expected impact:** [if mentioned]\n"
        "Do NOT add savings ideas not present in the input.\n"
        "Return only the formatted content, no heading.\n\n"
        "Source fragments:\n{fragments}\n\nFormatted output:"
    ),
    "architecture_reference": (
        "You are a senior technical writer producing a KT document.\n"
        "Section: {title}\n\n"
        "Rewrite these fragments into an architecture reference.\n"
        "Format:\n"
        "**Architecture summary:** [overview]\n"
        "**Main components:** [components and responsibilities]\n"
        "**Dependencies:** [important integrations]\n"
        "Do NOT add architectural facts not present in the input.\n"
        "Return only the formatted content, no heading.\n\n"
        "Source fragments:\n{fragments}\n\nFormatted output:"
    ),
    "open_responsibilities": (
        "You are a senior technical writer producing a KT document.\n"
        "Section: {title}\n\n"
        "Rewrite these fragments into an open responsibilities and transition plan.\n"
        "Format:\n"
        "**Open item:** [responsibility or gap]\n"
        "**Owner / contact:** [if mentioned]\n"
        "**Next step:** [what should happen next]\n"
        "Do NOT add ownership or transition items not present in the input.\n"
        "Return only the formatted content, no heading.\n\n"
        "Source fragments:\n{fragments}\n\nFormatted output:"
    ),
    "first_30_day_ownership": (
        "You are a senior technical writer producing a KT document.\n"
        "Section: {title}\n\n"
        "Rewrite these fragments into a first 30-day ownership plan.\n"
        "Format:\n"
        "**Week 1:** [focus]\n"
        "**Week 2:** [focus]\n"
        "**Week 3-4:** [focus]\n"
        "Do NOT add milestones not present in the input.\n"
        "Return only the formatted content, no heading.\n\n"
        "Source fragments:\n{fragments}\n\nFormatted output:"
    ),
    "handover_completion": (
        "You are a senior technical writer producing a KT document.\n"
        "Section: {title}\n\n"
        "Rewrite these fragments into a handover completion checklist.\n"
        "Format:\n"
        "**Completion status:** [done / pending]\n"
        "**Sign-off:** [who signs off, if mentioned]\n"
        "**Remaining action:** [if any]\n"
        "Do NOT add completion criteria not present in the input.\n"
        "End with one concise sign-off sentence such as: 'This handover is ready for sign-off and transition to the next owner.'\n"
        "Return only the formatted content, no heading.\n\n"
        "Source fragments:\n{fragments}\n\nFormatted output:"
    ),
    "default": (
